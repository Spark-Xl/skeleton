...
public class ReceiptsRecord extends UpdatableRecordImpl<ReceiptsRecord> implements Record6<Integer, Timestamp, String, BigDecimal, Integer, String> {

	private static final long serialVersionUID = -953404843;
	...
	/**
	 * Setter for <code>public.receipts.thumbnail</code>.
	 */
	...
	/**
	 * Getter for <code>public.receipts.thumbnail</code>.
	 */
	 ...
	 */
	@Override
	public Row6<Integer, Timestamp, String, BigDecimal, Integer, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row6<Integer, Timestamp, String, BigDecimal, Integer, String> valuesRow() {
	...
	public Field<String> field6() {
		return Receipts.RECEIPTS.THUMBNAIL;
	}
	 ...
	 */
	@Override
	public ReceiptsRecord values(Integer value1, Timestamp value2, String value3, BigDecimal value4, Integer value5, String value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ReceiptsRecord(Integer id, Timestamp uploaded, String merchant, BigDecimal amount, Integer receiptType, String thumbnail) {
		super(Receipts.RECEIPTS);
